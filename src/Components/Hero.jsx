    ...
    return (
        <div className={'h-svh overflow-y-hidden overflow-x-hidden md:h-svh relative'}>
            <div className={`flex flex-col justify-center align-middle items-center h-svh`}>
                <h1 id={'text'} className={`md:text-8xl z-10 ${darkTheme? "" :"text-black"}`}>Crafting Digital Experiences</h1>
                <h1 id={'text'} className={`md:text-8xl z-10 mb-10 ${darkTheme? "" :"text-black"} `}>Through Code & Design</h1>
                <h1 id={'text'} className={`md:mt-10 md:text-xl z-10 ${darkTheme? "" :"text-black"} `}>Building immersive web experiences that push</h1>
                <h1 id={'text'} className={`md:text-xl z-10 ${darkTheme? "" :"text-black"} `}>the boundaries of what's possible</h1>
            </div>
