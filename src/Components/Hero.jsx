    ...
    return (
        <div className={'h-svh overflow-y-hidden overflow-x-hidden md:h-svh'}>
            <div className={`flex flex-col justify-center align-middle items-center h-svh`}>
                <h1 id={'text'} className={`text-8xl z-10`}>Crafting Digital Experiences</h1>
                <h1 id={'text'} className={`text-8xl z-10 mb-10`}>Through Code & Design</h1>
                <h1 id={'text'} className={`mt-10 text-xl z-10`}>Building immersive web experiences that push</h1>
                <h1 id={'text'} className={`text-xl z-10`}>the boundaries of what's possible</h1>
            </div>
