    ...
    return (
        <div className={'h-svh md:h-svh relative'}>
            <div className={`flex flex-col justify-center align-middle items-center h-svh`}>
                ...
                <h1 id={'text'} className={`mt-10 text-md lg:text-xl sm:text-xl z-10 ${darkTheme? "" :"text-black"} `}>Building immersive web experiences that push</h1>
                <h1 id={'text'} className={`sm:text-xl lg:text-xl text-md z-10 ${darkTheme? "" :"text-black"} `}>the boundaries of what's possible</h1>
            </div>
